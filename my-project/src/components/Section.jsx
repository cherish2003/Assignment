...
export const Section = () => {
  return (
    <section id="next-section" class="text-gray-600 body-font">
      <div class="pl-16 px-4 mx-auto flex flex-row  pt-10 mb-6">
        <div class="w-1/2 flex flex-col items-start mb-0 text-start mx-auto flex-grow ">
          <div>
            <div class="text-left font-bold pl-12 pr-6 py-3 max-w-fit mt-10 bg-white rounded-full shadow-lg relative custombtn">
          ...
          <div class="pr-16">
            <div class="line  py-6">
              <h1 class="  text-4xl font-semibold text-capitalize  leading-10 text-black">
                Take Control
                <br class="block " />
                <span class="highlight-text-color ">
                  Monitor Usage &amp; Change Filters
                </span>
                <span class=" block mt-2 text-black">No Technician Needed</span>
              </h1>
            </div>
            <p class=" mb-6  ">
          ...
          <div class="pr-12 ">
            <div class="flex mb-4 relative">
              ...
              <div class="info-wrap">
                <h2 class="text-xl w-full  mb-3 font-bold font-plusJakartaSans capitalize text-gray-800 ">
                  Smart Water Purifier With Self Servicing Capability
                </h2>
                <p class=" font-normal font-plusJakartaSans text-base leading-relaxed text-gray-600 pr-0">
                  Say goodbye to the hassle of scheduling a technician for
                  purifier maintenance with our
                  <span class="font-bold "> self-replacing </span> filters.
                </p>
              </div>
            </div>
            <div class="flex  relative">
              ...
              <div class="info-wrap">
                <h2 class="text-xl  mb-3 font-bold capitalize text-gray-800 font-plusJakartaSans ">
                  Compensation For Service Delays
                </h2>
                <p class=" text-gray-600 font-normal para font-plusJakartaSans text-base leading-relaxed ">
                  You are entitled to a compensation of{" "}
                  <span class="font-bold ">100 Rs/Day </span> if service is
                  delayed for more than 24 hours.
                </p>
              </div>
            </div>
          </div>
          <button class="rounded-full bg-blue-500 w-fit  px-12 py-5 flex m-auto mt-8 mb-14">
            <a
              href="#pure"
              rel="nofollow"
              class=" text-white font-bold mx-auto"
            >
        ...
        <div class="pt-10 w-1/2 ">
          <img
            ...
            alt="hero"
            class=" w-full rounded transition-transform ease-in-out  max-w-full cursor-pointer object-cover relative object-center hover:-translate-y-2 duration-300 pr-4"
          />
        </div>
      </div>
    </section>
